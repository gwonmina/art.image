...
# Google Drive 파일 ID
file_id = '1-4Hn4sNO66fK7l1ZKluBC5iQWF-1kffk'
...
content_data = {
    labels[0]: {
        'images': [
            "https://i.ibb.co/SrdbY45/2.jpg",
            "https://i.ibb.co/wh1ZQcM/1.jpg",
            "https://i.ibb.co/1GsctXC/image.jpg"
        ],
        'texts': [
            "개인적 스타일과 창의성 강조",
            "다양한 매체와 재료 사용",
    ...
    labels[1]: {
        'images': [
            "https://i.ibb.co/gJdv8Jg/1733816510.jpg",
            "https://i.ibb.co/wwFQNrb/image.jpg",
            "https://i.ibb.co/3hBr0WP/3.jpg"
        ],
        'texts': [
            "풍부한 색감과 중첩된 채색",
            "빠른 표현과 대담한 붓질",
    ...
    labels[2]: {
        'images': [
            "https://i.ibb.co/Z17B130/2.jpg",
            "https://i.ibb.co/m0pwstW/image.jpg",
            "https://i.ibb.co/zsrxS50/1.jpg"
        ],
        'texts': [
            "극사실주의와 정확한 묘사력",
            "속도와 완성도",
